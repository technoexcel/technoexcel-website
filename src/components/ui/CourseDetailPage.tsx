...
export function CourseDetailPage({ slug, title, badge, duration, tagline, description, outcomes, modules, whoFor, relatedSlug }: CourseDetailProps) {
      ...
      <section id="te-course" style={{background:CREAM,padding:"64px 52px"}}>
        ...
        <div className="cg">
          ...
          <div className="sidebar">
            <div className="sbox">
              <div style={{fontFamily:MONO,fontSize:10,letterSpacing:"1.5px",textTransform:"uppercase",color:"rgba(19,41,60,.48)",marginBottom:14}}>Ready to enrol?</div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:10}}>
                <a href="/contact" style={{display:"flex",alignItems:"center",justifyContent:"center",background:RED,color:"#fff",fontFamily:SANS,fontWeight:700,fontSize:15,padding:"15px",borderRadius:12,textDecoration:"none"}}>Enrol Now →</a>
            ...
            <div className="sbox" style={{background:BG}}>
              ...
              {["Live sessions with a real trainer","Your company's actual data used","30-day post-course support","Completion certificate"].map((f,i)=>(
